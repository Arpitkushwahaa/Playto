...
const Leaderboard = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-purple-50 rounded-xl shadow-lg p-6 sticky top-6 border border-purple-100">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900 flex items-center">
          <span className="mr-2 text-3xl">🏆</span> 
          <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Top Contributors</span>
        </h2>
        <span className="text-xs bg-purple-100 text-purple-700 px-3 py-1 rounded-full font-semibold">24h</span>
      </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className={`font-bold ${index < 3 ? 'text-purple-700 text-base' : 'text-purple-600 text-sm'}`}>
                        {user.karma} karma
                      </span>
                    </div>
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center space-x-1 text-xs text-gray-600">
                    ...
                    <span className="font-semibold text-blue-600">{user.comment_karma}</span> comments
                  </div>
                </div>
              </div>
            </div>
