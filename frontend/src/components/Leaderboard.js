    ...
    <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg p-6 sticky top-6 border border-blue-100">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900 flex items-center">
          ...
          <span className="bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">Top Contributors</span>
        </h2>
        <span className="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-semibold">24h</span>
      </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className={`font-bold ${index < 3 ? 'text-blue-700 text-base' : 'text-blue-600 text-sm'}`}>
                        {user.karma} karma
                      </span>
                    </div>
                  </div>
