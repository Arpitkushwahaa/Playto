    ...
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg p-6 mb-6 hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-sky-500 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-md">
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-sky-500 text-white rounded-lg hover:from-blue-700 hover:to-sky-600 transition-all duration-200 font-semibold shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                💬 Comment
              </button>
            </div>
